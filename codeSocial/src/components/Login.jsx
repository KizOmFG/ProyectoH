      ...
      <div className="mx-auto text-center" style={{ maxWidth: "500px" }}>
        ...
        <div className="mb-4">
          <img
            ...
            style={{ width: "100px" }}
          />
          <h1 className="h4 text-dark fw-bold mt-2">Bienvenido</h1>
        </div>
        ...
        <div className="card shadow">
          <div className="card-body">
            ...
            {/* Sección de registro */}
            <div className="mt-4">
              <h3 className="h6">¿Aún no eres miembro Starbucks Rewards?</h3>
              <div className="d-flex gap-2">
                ...
                <a href="/registro" className="btn btn-success flex-fill">
                  Crear nueva cuenta
                </a>
              </div>
            </div>
